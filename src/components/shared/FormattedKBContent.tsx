      ...
      {sections.map((section, index) => {
          ...
          return (
            <div key={key} className="space-y-2">
              <div className="flex gap-2 items-start">
                <div className="font-display flex-shrink-0 px-2 py-1 text-xs font-semibold uppercase rounded bg-muted text-muted-foreground">
                  Question
                </div>
              </div>
        ...
        if (section.type === 'answer') {
          return (
            <div key={key} className="space-y-2">
              <div className="flex gap-2 items-start">
                <div className="font-display flex-shrink-0 px-2 py-1 text-xs font-semibold uppercase rounded bg-success-muted text-success">
                  Answer
                </div>
              </div>
