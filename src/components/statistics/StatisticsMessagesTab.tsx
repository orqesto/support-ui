  ...
  return (
    <div id="panel-messages" role="tabpanel">
      <div className="space-y-6 pb-6">
        {msgLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg First Response</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.avgHours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="avgHours" /></div><Timer className="w-10 h-10 text-muted-foreground" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P50 First Response</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.p50Hours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="p50Hours" /></div><Activity className="w-10 h-10 text-success" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P90 First Response</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.p90Hours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="p90Hours" /></div><TrendingUp className="w-10 h-10 text-warning" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Responded</p><p className="mt-2 text-3xl font-bold">{msgStats.firstResponseTime.totalResponded}</p></div><CheckCircle className="w-10 h-10 text-faint-foreground" /></div></CardContent></Card>
            </div>

            <div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg Resolution</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.avgHours)}</p></div><Timer className="w-10 h-10 text-muted-foreground" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P50 Resolution</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.p50Hours)}</p></div><Activity className="w-10 h-10 text-success" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P90 Resolution</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.p90Hours)}</p></div><TrendingUp className="w-10 h-10 text-warning" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Closed Messages</p><p className="mt-2 text-3xl font-bold">{msgStats.resolutionTime.totalClosed}</p></div><CheckCircle className="w-10 h-10 text-faint-foreground" /></div></CardContent></Card>
              </div>
            ...
            {msgStats.receiveToResolve ? (
              <div>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                  <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg Receive → Resolve</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.receiveToResolve.avgHours)}</p><OpenHours stats={msgStats.receiveToResolve.businessHours} pick="avgHours" /></div><Timer className="w-10 h-10 text-faint-foreground" /></div></CardContent></Card>
                  <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P50 Receive → Resolve</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.receiveToResolve.p50Hours)}</p><OpenHours stats={msgStats.receiveToResolve.businessHours} pick="p50Hours" /></div><Activity className="w-10 h-10 text-success" /></div></CardContent></Card>
                  <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P90 Receive → Resolve</p><p className="font-mono mt-2 text-3xl font-bold">{formatAvgReply(msgStats.receiveToResolve.p90Hours)}</p><OpenHours stats={msgStats.receiveToResolve.businessHours} pick="p90Hours" /></div><TrendingUp className="w-10 h-10 text-warning" /></div></CardContent></Card>
                  <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Resolved by a person</p><p className="mt-2 text-3xl font-bold">{msgStats.receiveToResolve.totalResolved}</p></div><CheckCircle className="w-10 h-10 text-faint-foreground" /></div></CardContent></Card>
                </div>
                <p className="mt-2 text-xs text-muted-foreground">
        ...
        {/* Labels Section */}
        <Card>
          <CardHeader><CardTitle className="flex items-center gap-2"><Tag className="h-5 w-5 text-muted-foreground" />Labels</CardTitle></CardHeader>
          <CardContent>
            {labelLoading ? (
