        ...
        {msgLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg First Response</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.avgHours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="avgHours" /></div><Timer className="w-10 h-10 text-muted-foreground" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P50 First Response</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.p50Hours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="p50Hours" /></div><Activity className="w-10 h-10 text-success" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P90 First Response</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.p90Hours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="p90Hours" /></div><TrendingUp className="w-10 h-10 text-warning" /></div></CardContent></Card>
            ...
            <div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg Resolution</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.avgHours)}</p></div><Timer className="w-10 h-10 text-muted-foreground" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P50 Resolution</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.p50Hours)}</p></div><Activity className="w-10 h-10 text-success" /></div></CardContent></Card>
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">P90 Resolution</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.p90Hours)}</p></div><TrendingUp className="w-10 h-10 text-warning" /></div></CardContent></Card>
