        ...
        {msgLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg First Response</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.firstResponseTime.avgHours)}</p><OpenHours stats={msgStats.firstResponseTime.businessHours} pick="avgHours" /></div><Timer className="w-10 h-10 text-primary" /></div></CardContent></Card>
            ...
            <div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <Card><CardContent className="p-6"><div className="flex justify-between items-center"><div><p className="text-sm font-medium text-muted-foreground">Avg Resolution</p><p className="mt-2 text-3xl font-bold">{formatAvgReply(msgStats.resolutionTime.avgHours)}</p></div><Timer className="w-10 h-10 text-primary" /></div></CardContent></Card>
