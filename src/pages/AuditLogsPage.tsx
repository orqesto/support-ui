...
const ACTION_OPTIONS = [
  ...
  { value: 'organization.update', label: 'Workspace → Update' },
  { value: 'organization.member_add', label: 'Workspace → Member Add' },
  { value: 'organization.member_remove', label: 'Workspace → Member Remove' },
  ...
  { value: 'documentation.upload', label: 'Documentation → Upload' },
  { value: 'documentation.update', label: 'Documentation → Update' },
  { value: 'documentation.toggle_enable', label: 'Documentation → Enable/Disable' },
  { value: 'documentation.delete', label: 'Documentation → Delete' },
  { value: 'label.create', label: 'Label → Create' },
  { value: 'label.update', label: 'Label → Update' },
  { value: 'label.delete', label: 'Label → Delete' },
